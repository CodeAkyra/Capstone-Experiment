...
<div class="header">
    ...
    <a href="<?= BASE_URL ?>installation/installation-request-material.php" class="btn-cancel">Discard Changes</a>
    <button class="btn-create" id="saverequestBtn">Save Changes</button>
</div>
