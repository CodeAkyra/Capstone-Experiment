...
<div class="header">
    ...
    <div class="header-buttons">
        <a href="<?= BASE_URL ?>inventory/forms/view-released.php" class="btn-cancel">Back</a>
    </div>
</div>
        ...
        <table class="table-view-records">
            ...
            <tbody class="td-style">
                <tr>
                    ...
                    <td class="td-action"><a href="view-batch-completed-image.php" class="view-button"><i class="btnView fa-solid fa-eye"></i></a></td>
...
<div id="released-completed-modal" class="modal">
    <div class="start-release-material-content">
        <div class="item-summary-header">
            <span>Released Material Completed</span>
